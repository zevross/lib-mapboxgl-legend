# ZRSA mapboxgl-legend (fork)

This repository is published privately to GitHub Packages as `@zevross/mapboxgl-legend`. It is a fork of the original `mapboxgl-legend` package with minor improvements. The original package can be found at [mapboxgl-legend](https://github.com/markusand/mapboxgl-legend).

## Installing this package

Docs: https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-npm-registry#installing-a-package

To install this package in another project:

1. [Obtain a GitHub PAT](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic) with read:packages scope for @zevross/lib-mapboxgl-legend

2. Add the PAT to your shell environment. Run this line in your terminal, or add it to your shell config file (e.g. `~/.bashrc` or `~/.zshrc`):

```shell
export NPM_TOKEN=<your_token_here>
```

3. Create a file called `.npmrc` in the root of your project with the following content:

```shell
@zevross:registry=https://npm.pkg.github.com
//npm.pkg.github.com/:_authToken=${NPM_TOKEN}
```

4. Install the package with npm/pnpm:

```shell
pnpm install @zevross/mapboxgl-legend
```

## Changes from original package

- Add a chevron arrow to each layer so it is more obvious you can collapse layers in the legend
